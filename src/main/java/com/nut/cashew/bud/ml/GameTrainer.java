...
/**
 * Direction-aware Q-learning for throne control.
 * - Supports 2 teams (A, B)
 * - Alternates training each episode
 * - Game ends when any team holds throne for 5 turns
 */
public class GameTrainer {
	...
	public static final class ActionSpec {
		...
		public ActionSpec(char move, char faceDir) {
			this.move = move;
		...
		public boolean equals(Object o) {
			...
			if (!(o instanceof ActionSpec)) return false;
			ActionSpec other = (ActionSpec) o;
			return move == other.move && faceDir == other.faceDir;
		}

		@Override
		public int hashCode() {
			return Objects.hash(move, faceDir);
		}
	}
	...
	private static final class QKey {
		...
		public boolean equals(Object o) {
			...
			QKey k = (QKey) o;
			return Objects.equals(s, k.s) && Objects.equals(a, k.a);
		}
	...
	public static final class RlAgent {
		...
		public ActionSpec bestAction(StateKey s) {
			return chooseAction(s, 0.0);
		}
	...
	public static void main(String[] args) throws Exception {
		...
		for (int episode = 1; episode <= EPISODES; episode++) {
			...
			// Alternate training team each episode
			...
			while (!done && steps < MAX_STEPS) {
				...
				// Learner state
				StateKey s = new StateKey(learner.getX(), learner.getY(), Character.toLowerCase(learner.direction));
				...
				if (winningTeam != null) {
					// Game finished
					if (winningTeam.equals(learner.team)) {
						reward = 100; // we won
					} else {
						reward = -100; // lost
					}
